<%-- 
    Document   : register
    Created on : 15 nov 2025, 22:34:01
    Author     : mundodevp
--%>
                ...
                <div class="authentication-inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-2">Registro de usuario Admin 🚀</h4>
                            <p class="mb-4">Ingresar los datos necesarios</p>
                            <form id="formAuthentication" class="mb-3" action="<%= request.getContextPath()%>/admin" method="POST">
                                ...
                                <div class="mb-3 form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input
                                            ...
                                            aria-describedby="password"
                                            <%
                                                if (request.getAttribute("confContrasenia") != null) {
                                            %>
                                            value="<%= request.getAttribute("confContrasenia")%>"
                                            <%
                                                }
                                            %>
                                            required
