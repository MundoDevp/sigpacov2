                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Instructor /</span> Editar</h4>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" 
                                                               name="apellidos" id="lastName" 
                                                               value="<%= instructor.getApellidos()%>"
                                                               required/>
                                                    </div>  
